#pragma once
// New ControllerRogMapServer using NavflexActionBase framework.
 ...
 */
class ControllerRogMapServer : public nav2_util::LifecycleNode
{
public:
  using ControllerMap =
    std::unordered_map<std::string, navflex_rogmap_core::Controller::Ptr>;
...
private:
  ...
  // -------- plugins --------
  pluginlib::ClassLoader<navflex_rogmap_core::Controller> lp_loader_;
