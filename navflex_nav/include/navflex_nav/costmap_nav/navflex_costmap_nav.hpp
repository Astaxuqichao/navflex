...
#include "navflex_nav/costmap_nav/behavior_action_costmap_server.hpp"
...
private:
  ...
  std::shared_ptr<navflex_nav::PlannerCostmapServer> planner_server_;
  ...
  std::shared_ptr<navflex_nav::ControllerCostmapServer> controller_server_;
  ...
  std::shared_ptr<navflex_nav::BehaviorCostmapServer> behavior_server_;
