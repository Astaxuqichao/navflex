...
#include "navflex_nav/costmap_nav/controller_action_costmap_server.hpp"
...
bool ControllerCostmapServer::findControllerId(
  ...
  double yaw_goal_tolerance)
{
  ...
  return std::make_shared<ControllerExecution>(
    controller_id,
    std::make_shared<Nav2ControllerAdapter>(controllers_.at(controller_id)),
    goal_checker,
    xy_goal_tolerance,
    yaw_goal_tolerance,
    robot_info_,
